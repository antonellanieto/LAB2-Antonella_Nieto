...
# API endpoint URL
url = "https://api.coingecko.com/api/v3/coins/bitcoin/market_chart/range?vs_currency=usd&from=1420081200&to=1672542000"
...
if response.status_code == 200:
    ...
    with open("bitcoin_price_data.csv", mode="w", newline="") as csv_file:
